...
public class Animal implements Comparable<Animal> {
  ...
  public Animal(String name, int baseHp, int baseSteps, int level) {
    this.name = name;
    this.baseHp = baseHp;
  ...
  public Animal(String name, int baseHp, int baseSteps, int level, int initialSteps) {
    this.name = name;
    this.baseHp = baseHp;
    this.baseSteps = baseSteps;
    this.level = level;
  ...
  @Override
  public int compareTo(Animal compareBug) {
