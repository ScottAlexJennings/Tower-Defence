...
public abstract class StudentAbs implements Student {
  ...
  public StudentAbs(int level, int baseAtk, int baseDly, int bugsEffected) {
    this.level = level;
  ...
  public abstract void specialAtk(Bug bug);
  ...
  public int defence(Building building) {
    ...
    try {
      ...
      Bug[] bugsArray = building.getAllBugs();
